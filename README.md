...
•	OpenWeatherMap API (hoặc API mà bạn đang dùng)

•	TailwindCSS (nếu có dùng)

•	LocalStorage để lưu city gần đây (nếu có)

________________________________________
🚀 Cách chạy dự án
Truy cập trực tiếp bằng miền đã triển khai

Dự án đã được deploy, bạn chỉ cần mở trình duyệt và truy cập:

https://thoitietvn.infinityfreeapp.com/
...
•	TailwindCSS hoặc CSS thuần: tùy dự án.
...
________________________________________
🎓 Bài Học Đạt Được Khi Học Thiết Kế Web

M viết web xong sẽ nắm được:
...
•	API miễn phí có giới hạn request → dùng cẩn thận.

•	Một số thành phố cần ghi rõ tên quốc gia để tránh trùng lặp.
________________________________________
👩‍💻 Tác giả
